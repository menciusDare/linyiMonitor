      ...
      <div class="panel-bd pdtlr-0">
              ...
              <div class="filter-con">
                <div class="el-select w124">
                  <el-select v-model="status" clearable placeholder="全部" style="height: 35px">
                    <el-option style="height: 35px" v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </div>
              </div>
              ...
              <div class="filter-con">
                <div class="el-select w124">
                  <div class="el-input el-input--suffix">
                    <el-date-picker style="width: 300px;height: 35px" v-model="tiem" value-format="yyyy-MM-dd" type="daterange" range-separator="—" start-placeholder="开始日期" end-placeholder="结束日期">
                    </el-date-picker>
                  </div>
                </div>
              </div>
            ...
            <li class="filter-item" style="height: 39px;margin-right: 0px">
              ...
              <div class="filter-con">
                <div class="el-input w180 el-input-group el-input--prefix">
                  ...
                  <el-input style="height: 35px;width: 160px" autocomplete="off" v-model.trim="entName" placeholder="搜索企业名称"></el-input>
            ...
            <li class="filter-item">
              ...
              <div class="filter-con">
                <div class="el-input w180 el-input-group el-input--prefix">
                  ...
                  <!--                                    <input type="text" autocomplete="off" placeholder="搜索企业名称"-->
                  <!--                                  class="el-input__inner">-->
                  <el-input style="height: 35px;width: 160px" autocomplete="off" v-model.trim="fiveNo" placeholder="搜索五联单编号"></el-input>
            ...
            <li class="filter-item">
              <div class="filter-btn">
                <!--<button type="button" class="button-type" @click="show">
                                    <span>查询</span></button>-->
                <el-button type="button" size="medium" :loading="searchLoading" @click="show" class="el-button el-button--primary">
                  <span>查询</span>
                </el-button>
              </div>
            </li>
            <li class="filter-item">
              <div class="filter-btn">
                <!--<button type="button" class="button-type" @click="basiReportList">
                                    <span>导出</span></button>-->
                <el-button type="button" size="medium" :loading="exportLoading" @click="basiReportList" class="el-button el-button--primary">
                  <span>导出</span>
                </el-button>
              </div>
            </li>
        ...
        <div class="el-pagination is-background mt-lg">
          ...
          <span class="el-pagination__sizes">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="cur_page" :page-sizes="pageSizes" :page-size="pageSize" layout="sizes, prev, pager, next" :total="total">
            </el-pagination>
          </span>
        ...
        <!--详情弹框-->
        <div>
          <el-dialog :modal-append-to-body="false" custom-class="openCla" :title="'编号'+formDate.fiveNo" :visible.sync="centerDialogVisibleOpen" width="50%" @close="closeData">
            <div style="font-size: 14px;color: #222;">
              <div>
                实际转出方：{{formDate.actualTransferor}}
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                行政处置说明文件：
                <span v-if="formDate.accessoryUrl != null" class="sep">
                  <el-button @click="fileDownload(formDate.accessoryUrl)" size="mini" type="primary" plain>下载文件</el-button>
                </span>
                <span v-else class="sep"> 无 </span>
              </div>
              <br/>
              <div style="border-bottom:1px dashed #adadad;padding-bottom: 25px">
                ...
                <div>
                  <table style="table-layout: fixed;width:74%;word-wrap:break-word;">
                    ...
                    <tbody>
                      <tr style="height: 25px;" v-for="(ite,index)  in formDate.vos" :key="index">
                ...
                <div style="margin-top: 10px">
                  计划转移时间：{{formatterDate(formDate.transportDate,"yyyy-MM-dd")}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  经办人：{{formDate.handledBy}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  经办人电话：{{formDate.contactsPhone}}
                </div>
              </div>
...
import downloadFile1 from "../../common/unit/DownloadFile1";
...
export default {
  ...
  methods: {
    ...
    fileDownload(url){
      var _this = this;
      let fileName = "行政处置说明文件-编号-" + _this.formDate.fiveNo;
      let params = new URLSearchParams();
      params.append('pathUrl', url);
      _this.$axios
        .post("/api/permissions/imageController/downLoad",  params, { responseType: "blob" })
        .then(function (response) {
            downloadFile1(response, fileName, url.split(".")[1]);
         })
        .catch(function () {
          _this.$message.info("文件下载异常, 请重试!");
        })
    },
    //KG转换吨
    getDun: function (str) {
    ...
    openDialog: function (item) {
      // console.log(item.id)
      // this.formDate=item;
      let url = "/api/regulatory/tEnterpriseTransportPlan/getPlanInfo/" + item.id
