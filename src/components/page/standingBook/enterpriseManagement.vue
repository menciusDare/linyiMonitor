...
export default {
    ...
    beforeRouteLeave(to, from, next) {
        if (to.name == 'newEntBase' || to.name == 'enterpriseProductionBook' || to.name == "managementEnterpriseProductionBook" || to.name == "collectEnterpriseProductionBook") {
                        ...
                        .then((res) => {
                            ...
                            if (res.code == 0) {
                                ...
                                for (let key in this.ruleForm) {
                                    if(['business','checkList','checkList1','deviceManufacturerNum'].includes(key)) {
                                        this.ruleForm[key] = []
                                    } else {
                                        this.ruleForm[key] = ''
                                    }
