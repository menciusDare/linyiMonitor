...
export default {
    ...
    beforeRouteLeave(to, from, next) {
        if (to.name == 'newEntBase' || to.name == 'enterpriseProductionBook') {
        ...
        loadingData() {
            ...
            let params = {
              ...
              entSubclass: 1002,
                ...
                status: _this.productionStatus?parseInt(_this.productionStatus):null
            };
