    ...
    <div class="main-top">
      <div class="breadcrumb">
        <a href="#">
          ...
          <span class="text-primary-font">产废单位管理</span>
        </a>
        <span class="sep">&gt;</span>
        <a href="#">
          <i class="icon icon-zhuanyun"></i>
          <span class="text-primary-font">管理台账</span>
        </a>
      </div>
    </div>
    <div class="panel">
            ...
            <thead>
              <tr>
               ...
               <!-- <th style="text-align:center;width: 10%">容器个数</th>-->
                ...
                <th style="text-align:center;width: 10%">运输企业</th>
                ...
                <table class="table-text">
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="list-text">{{tableData.monitorType}}</div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      <div class="list-text">{{nameLable == 'second' ?tableData.codeStr:tableData.dictDetailCode}}</div>
                    </td>
                    <td>
