                ...
                <div class="tab-video" style="">
                    ...
                    <div class="tab-bd">
                        <div class="video-item is-active">
                            <!-- 左侧车间 -->
                            <div class="video-big">
                                <div class="video-box" style="width: 640px;height: 425px" v-if="manufacturerType===0">
                                    <iframe
                                            :src="videoUrl"
                                            width="100%"
                                            height="100%"
                                ...
                                <div class="video-box"  style="width: 640px;height: 425px" v-else-if="manufacturerType===1">
                                    <dMonitor  :url="videoUrl" :kitToken = "kitToken" :poster = "poster"></dMonitor>
                                    <div class="video-state">
                                        <a>{{cameraName}}<i class="icon icon-shipin"></i></a>
                                    </div>
                                </div>
                                <div class="video-box"  style="width: 640px;height: 425px" v-else-if="manufacturerType===2">
                                    <DahuaMonitor :item="item"  :url="videoUrl" :kitToken = "kitToken" :poster = "poster"></DahuaMonitor>
                                    <div class="video-state">
                                        <a>{{cameraName}}<i class="icon icon-shipin"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="video-auto">
                                <div class="video-box" v-for="imte in videoList" style="width: 300px;height: 180px">
                                    <div class="video-image" v-if="imte.manufacturerType===0">
                                        <iframe
                                                :src="imte.url"
                                                width="100%"
                                                height="100%"
                                    ...
                                    <div class="video-image"  style="width: 300px;height: 180px"  v-else-if="imte.manufacturerType===1" >
                                        <xMonitor :url="imte.url"
                                                  :poster = "imte.poster"  :kitToken = "imte.kitToken"></xMonitor>
                                    </div>
                                    <div class="video-image"  style="width: 300px;height: 180px" v-else-if="imte.manufacturerType===2">
                                        <DahuaMonitorSmall :item="imte" :domId="imte.id" :url="imte.url" :kitToken = "imte.kitToken" :poster = "imte.poster"></DahuaMonitorSmall>
                                        <div class="video-state">
                                            <a>{{cameraName}}<i class="icon icon-shipin"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-bd" style="padding: 0 10px 0px;transform: translate(0px,19px)">
                                    <div class="operate-area">
                                        ...
                                        <div class="oper-direction">
                                            <!-- 选中样式根据情况需要is-active -->
                                            <div class="direction-cont top" @click="controlVideo(0)" @mousedown="controlSpeedStart(0)" @mouseup="controlTimer"><i class="icon icon-shang"></i></div>
                                            <div class="direction-cont is-active right" @click="controlVideo(3)" @mousedown="controlSpeedStart(3)" @mouseup="controlTimer"><i class="icon icon-you"></i></div>
                                            <div class="direction-cont bottom" @click="controlVideo(1)" @mousedown="controlSpeedStart(1)" @mouseup="controlTimer"><i class="icon icon-xia"></i></div>
                                            <div class="direction-cont leftControl" @click="controlVideo(2)" @mousedown="controlSpeedStart(2)" @mouseup="controlTimer"><i class="icon icon-zuo"></i></div>
                                        </div>
                                        <!-- 调节 -->
                                        <div class="oper-adjust">
                                            <div class="contord">
                                                <div class="slide-box" >
                                                    <div class="imgIcon" @click="chooseJiaoJu(manufacturerType===0?10:8)">
                                                        <i class="el-icon-plus"></i>
                                                    </div>
                                                    <div class="slide-name">焦距</div>
                                                    <div class="imgIcon jian" @click="chooseJiaoJu(manufacturerType===0?11:9)">
...
<script>
    import dMonitor from './views/dMonitor';
    import xMonitor from './views/xMonitor';
    import DahuaMonitor from './views/DahuaMonitor.vue'
    import DahuaMonitorSmall from './views/DahuaMonitorSmall.vue'
    ...
    export default {
        ...
        methods:{
            ...
            controlVideo(direction) {
                ...
                params.append('factoryType', _this.manufacturerType);
            ...
            videoInfo(item){
                if(item){
                    this.videoUrl = JSON.parse(JSON.stringify(item.url.replace("autoplay=2",'autoplay=1')))
                    this.videoAdress = item.urlAdress;
                    this.cameraName = item.cameraName;
                    this.videoId = item.id;
                    this.manufacturerType = item.manufacturerType;
                    this.kitToken = item.kitToken;
            ...
            openVideoNow(){
                ...
                _this.$nextTick(() => {
                    ...
                    params.append('entId', _this.item.entId);
                    // params.append('factoryType',  _this.item.manufacturerType);
