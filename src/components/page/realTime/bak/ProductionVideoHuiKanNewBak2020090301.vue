    ...
    <el-dialog :visible.sync="dialogHK" v-if="dialogHK" :title="item.name" :center="true" :modal-append-to-body="false" :close-on-click-modal="false" top="10px" width="1000px" @close = "closeBtn">
        ...
        <!--        <div style="padding-top: 5px;">
                ...
                <div class="tab-video" style="">
                    <div class="tab-hd">
                        <ul class="tab-head">
                            <li class="is-active"><i class="icon icon-buju"></i></li><!--<li><i class="icon icon-buju1"></i></li><li class="ratio-txt"><span>16/9</span></li>-->
                        </ul>
                    </div>
                    <div class="tab-bd">
...
<!--                            <div class="video-auto"  v-if="videoListNew.length<=0">
                                <div class="video-box" style="width: 300px;height: 180px">
                                    <div class="video-image">
