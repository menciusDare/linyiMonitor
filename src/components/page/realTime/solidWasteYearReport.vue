<template>
    ...
    <div class="main">
            ...
            <div class="panel-bd">
                    ...
                    <i class="el-input__icon el-icon-search"></i>
                        ...
                        <li class="filter-item">
                            <div class="filter-btn">
                                <el-button type="button" size="medium" @click="listSolidWasteAnnals"
                ...
                <div class="total-number" style="margin-left: 3px;">
                    ...
                    <div class="total-text">
                        已提交企业
                        <span class="num" style="color:green">{{count.commitCount}}</span>家
                    </div>
                    <div class="total-text is-offline">
                        未提交企业
                        <span class="num" style="color:red">{{count.notCount}}</span>家
                    </div>
                </div>
                <table class="table-default">
                    ...
                    <tr v-for="(item,index) in dataList" :key="index">
                        ...
                        <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 8%" :title="item.regionName"
                        >{{item.regionName}}
                        </td>
                        <td
        ...
        <SolidWasteYearReportSee ref="SonSee"></SolidWasteYearReportSee>
    </div>
</template>
...
<script>
 ...
 import SolidWasteYearReportSee from "./solidWasteYearReportSee.vue"
    ...
    export default {
        ...
        methods: {
            ...
            adudit(item) {
                ...
                this.yearReportAudit.declareYear = this.search.year;
                this.auditDialogVisible = true;
                this.getAuditSolidWasteAnnalsQuarterInfo(item);
            },
            ...
            listSolidWasteAnnals() {
                ...
                _this.cur_page = 1;
                _this.solidWasteAnnalsEntStatistics();
                _this.pageList();
            },
            solidWasteAnnalsEntStatistics() {
                var _this = this;
                ...
                _this.$axios
                    .get("/api/regulatory/commonlysolidwaste/solidWasteAnnalsEntStatistics", {
                        params,
                    })
                    .then(function (res) {
                        if (res.code == 0) {
            ...
            pageList() {
                ...
                params.append("entName", _this.search.entName);
                _this.$axios
                    .get("/api/regulatory/commonlysolidwaste/listSolidWasteAnnals", {params})
                    .then(function (res) {
                        if (res.code == 0) {
            ...
            selectEntMonthYearReportInfo() {
                ...
                _this.$axios
                    .get("/api/regulatory/commonlysolidwaste/getDeclarationInfo/", {params})
                    .then(function (res) {
                        if (res.code == 0) {
                            debugger
    ...
    //   this.$router.push({ name: "solidWasteYearReportSee", query: { rowInfo: entId ? entId: '' ,entName:entName?entName:''} });
