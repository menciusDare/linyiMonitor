        ...
        <div class="panel">
            <div class="panel-bd">
                ...
                <div class="total-number" style="margin-left: 3px;">
                    ...
                    <div class="total-text">已提交企业<span class="num" style="color:green">{{count.one}}</span>家</div>
                    <div class="total-text is-offline">未提交企业<span class="num" style="color:red">{{count.two}}</span>家</div>
                </div>
                    ...
                    <div style="padding-bottom: 12px;height: 236px;overflow: auto;">
                        <table class="mytable-default" >
                            ...
                            <tr v-for="(item,index) in entMonthOrYearReportInfo.reportEntProductionVoList">
                                ...
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 15%" :title="formatDictDetailCode(item.dictDetailCode)">
                                ...
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 15%" :title="item.productionNumber">{{(item.productionNumber?item.productionNumber:0).toFixed(2)}}</td>
                                ...
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 15%" :title="item.handleNumber">{{(item.handleNumber?item.handleNumber:0).toFixed(2)}}</td>
                            </tr>
                    ...
                    <div style="padding-bottom: 12px;height: 236px;overflow: auto;">
                        <table class="mytable-default" >
                            ...
                            <tr v-for="(item,index) in entMonthOrYearReportInfo.reportEntEntrusts">
                                <td style="text-align:center;width: 10%">{{(cur_page-1)*pageSize+index+1}}</td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 10%" :title="formatDictDetailCode(item.dictDetailCode)">
                                    <!--<a href="javascript:;" class="text-second text-underline">-->
                                    {{formatDictDetailCode(item.dictDetailCode)}}
                                    <!--</a>-->
                                </td>
                                ...
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 15%" :title="item.handleType">{{item.handleType}}</td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 10%" :title="item.entrustNumber">{{(item.entrustNumber?item.entrustNumber:0).toFixed(2)}}</td>
                            </tr>
                    ...
                    <div style="padding-bottom: 12px;height: 236px;overflow: auto;">
                        <table class="mytable-default" >
                            ...
                            <tr v-for="(item,index) in entMonthOrYearReportInfo.reportEntStorageVos">
                                <td style="text-align:center;width: 10%">{{(cur_page-1)*pageSize+index+1}}</td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 20%" :title="formatDictDetailCode(item.dictDetailCode)">
                                    <!--<a href="javascript:;" class="text-second text-underline">-->
                                    {{formatDictDetailCode(item.dictDetailCode)}}
                                    <!--</a>-->
                                </td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 20%" :title="item.harmfulName">{{item.harmfulName}}</td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 20%" :title="item.legacyMonth">{{(item.legacyMonth?item.legacyMonth:0).toFixed(2)}}</td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 20%" :title="item.lastMonth">{{(item.lastMonth?item.lastMonth:0).toFixed(2)}}</td>
                                <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 20%" :title="item.thisMonth">{{(item.thisMonth?item.thisMonth:0).toFixed(2)}}</td>
                            </tr>
    ...
    export default {
        ...
        methods:{
            ...
            searchEntManagementPlanReport(){
              ...
              _this.initCountData();
              _this.cur_page = 1;
              _this.selectEntMonthYearReportCountEnt();
              _this.pageList();
            },
