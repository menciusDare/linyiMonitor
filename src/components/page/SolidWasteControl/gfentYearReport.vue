<template>
    ...
    <div class="main">
                        ...
                        <tr v-for="(item, index) in dataList">
                            ...
                            >
                                <div
                                    ...
                                    class="text-state state-anomaly"
                                >
                                    审核拒绝
                                </div>
                                <div
                                    v-if="item.auditStatus == 0"
                                    class="text-state untreated"
                                >
                                    已提交未审核
                                </div>
                                <div
                                ...
                                <div
                                    v-if="item.auditStatus == null"
                                    class="text-state state-off"
                                >
                                    未提交
                                </div>
                            </td>
        ...
        >
            ...
            <div>
                <div
                    style="font-size: large;color: black;padding-bottom: 12px;"
                >
                ...
                <div style="padding-bottom: 12px;height: 236px;overflow: auto;">
                    <table class="mytable-default">
                        ...
                        <tbody>
                            <tr
                                v-for="(item,
                                index) in entMonthOrYearReportInfo.reportEntProductionVoList"
                            >
                            ...
                            <tr
                                v-if="
                                    entMonthOrYearReportInfo.reportEntProductionVoList
                                "
                            >
                ...
                <div style="padding-bottom: 12px;height: 236px;overflow: auto;">
                    <table class="mytable-default">
                        ...
                        <tbody>
                            <tr
                                v-for="(item,
                                index) in entMonthOrYearReportInfo.reportEntEntrusts"
                            >
                                <td style="text-align:center;width: 10%">
                                    {{ (cur_page - 1) * pageSize + index + 1 }}
                                </td>
                            ...
                            <tr
                                v-if="
                                    entMonthOrYearReportInfo.reportEntEntrusts
                                "
                            >
                ...
                <div style="padding-bottom: 12px;height: 236px;overflow: auto;">
                    <table class="mytable-default">
                        ...
                        <tbody>
                            <tr
                                v-for="(item,
                                index) in entMonthOrYearReportInfo.reportEntStorageVos"
                            >
                                <td style="text-align:center;width: 10%">
                                    {{ (cur_page - 1) * pageSize + index + 1 }}
                                </td>
                            ...
                            <tr
                                v-if="
                                    entMonthOrYearReportInfo.reportEntStorageVos
                                "
                            >
                                <td colspan="3" align="center">合计</td>
                                <td align="center">
        ...
        >
            ...
            >
                ...
                <div v-if="auditStatus != 1">
                    <el-form-item prop="status" label="审核状态：">
                        <el-select
                            v-model="yearReportAudit.status"
                            placeholder="请选择"
                        >
                            <el-option
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="addYearReportAudit"
                    >确 定</el-button
                >
            </span>
        </el-dialog>
...
export default {
    ...
    methods: {
            ...
            _this.$axios
                ...
                .then(function(res) {
                    if (res.code == 0) {
                        ...
                        if (
                            _this.yearAuditList != null &&
                            _this.yearAuditList.length > 0
                        ) {
                            _this.auditStatus =
                                _this.yearAuditList[0].auditStatus;
                        }
                    }
                })
                .catch((error) => {
        ...
        selectEntMonthYearReportCountEnt() {
            ...
            params.append("entSubClass", 1001);
            _this.$axios
        ...
        pageList() {
            ...
            params.append("entSubClass", 1001);
            _this.$axios
                .get("/api/regulatory/index/selectEntMonthYearReportList", {
                    params,
                })
                .then(function(res) {
                    if (res.code == 0) {
        ...
        selectManagementPlanFilingEntInfo(entId) {
            ...
            _this.$axios
                .get(
                    "/api/regulatory/index/selectManagementPlanFilingEntInfo/" +
                        entId
                )
                .then(function(res) {
                    if (res.code == 0) {
        ...
        selectEntMonthYearReportInfo() {
            ...
            params.append("sourceType", _this.search.sourceType);
            _this.$axios
                .get("/api/regulatory/index/selectEntMonthYearReportInfo/", {
                    params,
                })
                .then(function(res) {
                    if (res.code == 0) {
                        ...
                        if (reportEntProductionVoList.length > 0) {
                            for (
                                let i = 0;
                                i < reportEntProductionVoList.length;
                                i++
                            ) {
