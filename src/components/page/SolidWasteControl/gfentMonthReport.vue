        ...
        <div class="panel">
            <div class="panel-bd">
                ...
                <div class="total-number" style="margin-left: 3px;">
                    ...
                    <div class="total-text is-offline">
                        未提交企业<span class="num" style="color:red">{{
                            count.two
                        }}</span
                        >家
                    </div>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in dataList">
                            ...
                            <td
                                style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 10%"
                            >
                                <div v-if="item.submitime" class="text-state">
                                    已提交
                                </div>
                                <div v-else class="text-state state-off">
                                    未提交
                                </div>
                            </td>
                            <td
            ...
            >
                ...
                <div>
                    ...
                    <div
                        style="padding-bottom: 12px;height: 236px;overflow: auto;"
                    >
