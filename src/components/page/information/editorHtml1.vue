<template>
  ...
  ></MainEditor>-->
  <!-- 富文本 -->
  <!--  <div class="main-con hei-full" style="padding:0">-->
  <div class="main">
    <!-- <div class="pdl-lgest">
      <ul class="filter-box">
        <h2>
        ...
        <el-select v-model="pageShow.receive" placeholder="请选择企业类型" style="width: 100%;" clearable>
          <el-option
    ...
    <!-- <div class="pdl-lgest">
      <ul class="filter-box">
        ...
        <el-select v-model="pageShow.type" placeholder="请选择消息类型" style="width: 100%;" clearable>
          <el-option
...
import warningInfoJs from "./warningInfoJs";
...
export default {
  ...
  methods: {
    ...
    //   this.pageShow.receive = obj.receive;
    //   this.pageShow.type = obj.type;
    ...
    saveValue() {
      ...
      if (!this.pageShow.id) {
        //新增
        let params = {};
        params["receive"] = this.pageShow.receive;
        params["type"] = 2;
        params["content"] = this.Value;
        warningInfoJs.saveOrUpdate(params).then((res) => {
          this.$message({
            message: "保存成功",
            type: "success",
          });
        ...
        // this.$router.push('/stationWarning')
      }

      // this.pageShow.infoHtml = this.Value
      // pageShowJs.saveOrUpdate(this.pageShow).then(res => {

      //   //路由跳转
      //   if (this.pageShow.pageId == 1) {
      //     this.$router.push('/regionWarning')
      //   } else if (this.pageShow.pageId == 2) {
      //     this.$router.push('/stationWarning')
      //   }
      //   //sidebar样式切换
      //   this.$emit('show-class-change', 1)
      // })
    },
    cancelSave() {
      this.$router.push("informationTable");
    },
  },
};
</script>
